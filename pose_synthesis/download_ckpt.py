...
if __name__ == "__main__":
    ckpts = {
        ...
        "elevation_estimate/utils/weights/indoor_ds_new.ckpt" : "https://huggingface.co/One-2-3-45/code/resolve/main/elevation_estimate/utils/weights/indoor_ds_new.ckpt?download=true"
    }
